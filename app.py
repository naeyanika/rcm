...
# Link to raw GitHub content
url_github = 'https://github.com/naeyanika/rcm/raw/master/RCM.xlsx'
...
try:
    ...
    st.write("Please check if the file is accessible and the URL is correct.")
